...
<body class="font-sans antialiased bg-gray-50 text-gray-900">
	<!-- Header -->
	<header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
				...
				<nav class="hidden lg:flex items-center space-x-1">
					...
					<div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative">
						...
						<div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
							...
							<a href="{{ route('profile.staff') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Tenaga
								Pendidik</a>
							<a href="{{ route('profile.facilities') }}"
								class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Fasilitas</a>
							<a href="{{ route('profile.students') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Data
								Siswa</a>
						</div>
					</div>
					...
					<div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative">
						...
						<div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
							...
							<a href="{{ route('graduates.alumni') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Data
								Alumni</a>
						</div>
					</div>
					...
					<div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative">
						...
						<div x-cloak x-show="open" x-transition:enter="transition ease-out duration-200"
							...
							<a href="{{ route('gallery.photos') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Foto</a>
							<a href="{{ route('gallery.videos') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Video</a>
						</div>
					</div>
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				...
				<div>
					...
					<ul class="space-y-2 text-sm">
						<li><a href="{{ route('profile.vision-mission') }}" class="hover:text-primary-400 transition">Visi & Misi</a>
						</li>
						<li><a href="{{ route('profile.staff') }}" class="hover:text-primary-400 transition">Tenaga
								Pendidik</a></li>
						<li><a href="{{ route('graduates.achievements') }}" class="hover:text-primary-400 transition">Prestasi</a></li>
