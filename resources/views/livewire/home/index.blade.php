<div>
		...
		<div class="container mx-auto px-4 py-20 md:py-32 relative z-10">
			<div class="max-w-3xl animate-fade-in-up">
				<h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
					{{ $schoolProfile?->school_name ?? 'SMP Digital' }}
				</h1>
				<p class="text-xl md:text-2xl text-primary-100 mb-8">
					{{ $schoolProfile?->vision ?? 'Unggul dalam Prestasi, Berkarakter dalam Kehidupan' }}
				</p>
			...
			<div class="container mx-auto px-4">
				<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
					<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
						...
						<div class="text-3xl font-bold text-gray-900 mb-1">{{ number_format($stats['students']) }}</div>
					...
					<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
						...
						<div class="text-3xl font-bold text-gray-900 mb-1">{{ $stats['teachers'] }}</div>
					...
					<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
						...
						<div class="text-3xl font-bold text-gray-900 mb-1">{{ $stats['achievements'] }}</div>
							...
							<div class="p-5">
								<div class="flex items-center gap-2 mb-3">
									...
									<span class="text-xs text-gray-500">
										{{ $news->publish_date?->diffForHumans() ?? $news->created_at->diffForHumans() }}
									</span>
								</div>
	...
	<section class="py-16">
		<div class="container mx-auto px-4">
			<div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-8 md:p-12 text-white text-center">
