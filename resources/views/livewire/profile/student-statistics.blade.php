		...
		@if ($statistics->isNotEmpty())
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
				<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
					...
					<div class="text-3xl font-bold text-gray-900 mb-1">{{ number_format($totalStats['total']) }}
					</div>
				...
				<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
					...
					<div class="text-3xl font-bold text-gray-900 mb-1">{{ number_format($totalStats['male']) }}
					</div>
				...
				<div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100 text-center">
					...
					<div class="text-3xl font-bold text-gray-900 mb-1">{{ number_format($totalStats['female']) }}
					</div>
						...
						<tbody class="divide-y divide-gray-200">
							@foreach ($statistics as $stat)
								<tr class="hover:bg-gray-50 transition">
									...
									<td class="px-6 py-4 text-center">
										<span class="px-3 py-1 bg-secondary-100 text-secondary-700 rounded-full text-sm font-semibold">
