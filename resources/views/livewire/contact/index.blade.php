...
$contactInfo = computed(fn() => ContactInfo::first());
        ...
        <div class="container mx-auto px-4">
            ...
            @if($this->contactInfo)
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $this->contactInfo->address }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $this->contactInfo->phone }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">{{ $this->contactInfo->email }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $this->contactInfo->whatsapp) }}"
                    ...
                    <!-- Map -->
                    @if($this->contactInfo->maps_embed)
                        <div class="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100">
                            <div class="aspect-square">
                                {!! $this->contactInfo->maps_embed !!}
                            </div>
                        </div>
                    @endif
                </div>
