...
mount(function (Achievement $achievement) {
    $this->achievement = $achievement;
});

$relatedAchievements = fn() => Achievement::where('category', $this->achievement->category)
    ...
    <div class="py-12 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                @if($this->relatedAchievements->isNotEmpty())
                    <div class="mt-12">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Prestasi Terkait</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            @foreach($this->relatedAchievements as $related)
